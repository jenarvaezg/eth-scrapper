...
//Address: 0x839c52cB18B02F2Af31Ad50070D6A9ea71aFDf79
//Contract name: ShortOrder
//Balance: 0 Ether
...
contract ShortOrder is SafeMath {
  ...
  function returnHash(address[2] tokenUser,uint[7] minMaxDWCPNonce)  external pure returns (bytes32) {
